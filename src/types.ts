...
export const ExportConfigSchema = z.object({
  ...
  defaultExports: z
    .enum(['ignore', 'named', 'passthrough'])
    .optional()
    .default('ignore'),
  naming: z
    .object({
      transform: z
        .enum(['kebab', 'camel', 'pascal', 'preserve'])
        .optional()
        .default('preserve'),
...
export type VariableBarrelDefinition = z.infer<
  typeof VariableBarrelDefinitionSchema
>

// Type guards
export function isVariableBarrelDefinition(
  def: BarrelDefinition
): def is VariableBarrelDefinition {
